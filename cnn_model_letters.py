...
if __name__ == "__main__":
    ...
    # ---- 创建输出目录 ----
    output_dir = os.path.join('data_letters', 'CNN')
    ...
    # 2. 混淆矩阵热力图
    # ================================================================
    draw_cm(all_labels, all_preds, letter_classes, output_dir, task="letters")

    # ================================================================
    # 3. 每类 Precision / Recall / F1 + 总体指标
    # ================================================================
    draw_per_class_metric(all_labels, all_preds, letter_classes, output_dir, task="letters")
